 ...
 */
 ...
 const resultApply = add.apply(obj, [10, 3]);
 
 // call & apply are similar , they both execute the bound function on the object immediately
 
 const funcBind = add.bind(obj, 12, 3);
